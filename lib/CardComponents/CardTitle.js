...
var CardTitle = React.createClass({displayName: "CardTitle",
	...
	render: function() {
		...
		var titleText = typeof this.props.children == 'string' ? (React.createElement("h2", {className: "mdl-card__title-text"}, this.props.children)) : (this.props.children);

		return (
			React.createElement("div", {className: "mdl-card__title", style: style}, 
				titleText
			)
		);
	}
